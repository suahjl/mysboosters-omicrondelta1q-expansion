...
# 0 --- Preliminaries
file_input = 'Data/MYSBoosters_TND_Data_Delta1Q_Expansion_ANONYMISED.parquet'  # Delta1Q_Expansion DATA
...
def logitVE(equation=eqn,
    ...
    fig.tight_layout()
    fig.savefig('Output/MYSBoosters_TND_Est1a_Delta1Q_Expansion_VE_' + output_suffix + '_Heatmap.png')
    ...
    dfi.export(_VE, 'Output/MYSBoosters_TND_Est1a_Delta1Q_Expansion_VE_' + output_suffix + '.png')
    _VE.to_csv('Output/MYSBoosters_TND_Est1a_Delta1Q_Expansion_VE_' + output_suffix + '.csv')

    dfi.export(_comorb_AOR, 'Output/MYSBoosters_TND_Est1a_Delta1Q_Expansion_comorbAOR_' + output_suffix + '.png')
    _comorb_AOR.to_csv('Output/MYSBoosters_TND_Est1a_Delta1Q_Expansion_comorbAOR_' + output_suffix + '.csv')
...
VE_consol.to_csv('Output/MYSBoosters_TND_Est1a_Delta1Q_Expansion_VE_consol.csv', index=True)
dfi.export(VE_consol, 'Output/MYSBoosters_TND_Est1a_Delta1Q_Expansion_VE_consol.png')
